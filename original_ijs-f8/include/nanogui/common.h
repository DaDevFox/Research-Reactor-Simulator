...
extern NANOGUI_EXPORT std::string formatDecimals(const double x, const int decDigits, const bool forceDecimals = false);

extern NANOGUI_EXPORT double get_seconds_since_epoch();
