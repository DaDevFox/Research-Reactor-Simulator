...
public:
	...
	void setNumberColor(const nanogui::Color& numberColor) { mNumberColor = numberColor; }

	const nanogui::Color& getPointerColor() const { return pointerColor; }
	void setPointerColor(const nanogui::Color& pointer_color) { pointerColor = pointer_color; }
