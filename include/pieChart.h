...
protected:
	...
	nanogui::Color dataColors[7] = { nanogui::Color(255,255), nanogui::Color(34,116,165,255), nanogui::Color(247, 92, 3,255), nanogui::Color(241, 196, 15, 255), nanogui::Color(0, 204, 102, 255), nanogui::Color(240, 58, 71, 255), nanogui::Color(153, 0, 153, 255) };
