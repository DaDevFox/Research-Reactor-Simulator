...
void SimulatorGUI::createOtherTab() {
  ...
  rel->appendCol(RelativeGridLayout::Size(
      120.f, RelativeGridLayout::SizeType::Fixed));  // 1 save button
  rel->appendCol(RelativeGridLayout::Size(
      10.f, RelativeGridLayout::SizeType::Fixed));  // 2 border
  rel->appendCol(RelativeGridLayout::Size(
      120.f, RelativeGridLayout::SizeType::Fixed));  // 3 load button
  rel->appendCol(RelativeGridLayout::Size(
      10.f, RelativeGridLayout::SizeType::Fixed));  // 2 border
  rel->appendCol(RelativeGridLayout::Size(
      120.f, RelativeGridLayout::SizeType::Fixed));  // 5 division thing
  rel->appendRow(RelativeGridLayout::Size(
      15.f, RelativeGridLayout::SizeType::Fixed));  // 0 top border
  rel->appendRow(RelativeGridLayout::Size(
      30.f, RelativeGridLayout::SizeType::Fixed));  // 1 Load and save settings
  rel->appendRow(RelativeGridLayout::Size(
      15.f, RelativeGridLayout::SizeType::Fixed));  // 2 Seperating space
  rel->appendRow(RelativeGridLayout::Size(
      30.f, RelativeGridLayout::SizeType::Fixed));  // 3 Load and save log
  rel->appendRow(RelativeGridLayout::Size(
      15.f, RelativeGridLayout::SizeType::Fixed));  // 4 Seperating space
  rel->appendRow(RelativeGridLayout::Size(
      30.f, RelativeGridLayout::SizeType::Fixed));  // 5 Rod Curves
  rel->appendRow(RelativeGridLayout::Size(
      15.f, RelativeGridLayout::SizeType::Fixed));  // 6 Seperating space
  rel->appendRow(RelativeGridLayout::Size(
      30.f, RelativeGridLayout::SizeType::Fixed));  // 7 Reset simulator
  rel->appendRow(RelativeGridLayout::Size(
      15.f, RelativeGridLayout::SizeType::Fixed));  // 8 Seperating space
  rel->appendRow(RelativeGridLayout::Size(
      30.f, RelativeGridLayout::SizeType::Fixed));  // 9 Load script
  ...
  saveBtn->setCallback([this]() {
    ...
    std::string saveFileName =
        file_dialog({{"rrs", "Simulator settings file"}}, true);
    if (saveFileName.substr((size_t)std::max(0, (int)saveFileName.length() - 4),
                            std::min((size_t)4, saveFileName.length())) !=
        ".rrs") {
  ...
  loadBtn->setCallback([this]() {
    ...
    std::string loadFileName =
        file_dialog({{"rrs", "Simulator settings file"}}, false);
  ...
  saveLogBtn->setCallback([this]() {
    std::string logFileName =
        file_dialog({{"dat", "Data file"}, {"txt", "Text file"}}, true);
  ...
  IntBox<int> *divisionBox =
      other_tab->add<IntBox<int>>(reactor->data_division);
  ...
  divisionBox->setCallback([this](int a) { reactor->data_division = a; });
  ...
  loadScriptBtn->setCallback([this]() {
    toggleBaseWindow(false);
    std::string loadFileName =
        file_dialog({{"rrs", "Simulator Script file"}}, false);
  ...
  resetBtn->setCallback([this]() { this->resetSimToStart(); });
}
